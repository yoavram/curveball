...
def lrtest(m0, m1, alfa=0.05):
    ...
    The function compares between two :py:class:`lmfit.model.ModelResult` objects. These are the results of fitting models to the same data set using the `lmfit <lmfit.github.io/lmfit-py>`_ package
    ...
    Args:
        - m0, m1: :py:class:`lmfit.model.Model` objects representing two models. `m0` is nested in `m1`.
