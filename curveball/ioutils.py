...
def read_tecan_xlsx(filename, label='OD', sheet=None, max_time=None, plate=None):
    ...
    Args:
        ...
        - plate: A :py:class:`pandas.DataFrame` object representing a plate, usually generated by reading a CSV file generated by `Plato <http://plato.yoavram.com/>`_.

    Returns:
        A :py:class:`pandas.DataFrame` containing the columns:
