...
version = curveball.__version__
# The full version, including alpha/beta/rc tags.
release = curveball.__version__
...
texinfo_documents = [
  ('index', 'curveball', u'Curveball Documentation',
   u'Yoav Ram', 'Curveball', 'Curveball analyzes microbial growth curves using ecological and evolutionary models',
   'Miscellaneous'),
]
