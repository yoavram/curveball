...
class ModelsTestCase(TestCase):
    ...
    def test_find_lam(self):
        df = self._randomize_data(logistic_ode)
        params = curveball.models.logistic_model.make_params(y0=self.y0, K=self.K, r=self.r)
        model_fit = curveball.models.logistic_model.fit(df.OD, t=df.Time, params=params)
        lam,fig,ax1,ax2 = curveball.models.find_lag(model_fit)
